...
def format_prompt(title, subtitle, author, style, language, length):
    ...
    First, generate a structured Table of Contents with concise chapter headings.
    ...
    - There is no fixed number of chapters. Include as many chapters as needed to tell the full story in a comprehensive and immersive way.
